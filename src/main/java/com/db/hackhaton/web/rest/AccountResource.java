                ...
                .orElseGet(() -> {
                    User user = userService
                        .createUser(managedUserVM.getLogin(), managedUserVM.getPassword(),
                            ...
                            managedUserVM.getEmail().toLowerCase(), managedUserVM.getCnp(),
                            managedUserVM.getPhone(), managedUserVM.getDisplayedGender(),
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUser(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),
                    userDTO.getCnp(), userDTO.getPhone(), userDTO.getDisplayedGender(), userDTO.getLangKey(), userDTO.getImageUrl());
